    ...
    return (
        <div className="add-course align">
            ...
            <form className="add-course__form" action="">
                ...
                <Field id="course-lang" fieldName="Language:" inputType="select" options={["English", "German", "Arabic"]}/>
                <Field id="course-lvl" fieldName="Level:" inputType="select" options={["Beginner", "Intermediate", "Advanced"]}/>
                <Field id="course-ctg" fieldName="Category:" inputType="select" options={["Technology", "Arts", "Sciences"]}/>
            ...
            <form className="add-course__form subpart-form" action="">
                ...
                <Field id="lesson-chapter" fieldName="Chapter" inputType="select" options={chapters.map(ch => ch.title)}/>
                <Field id="lesson-content" fieldName="Readings/Written Content" inputType="textarea"/>
                <div className="add-course__action">
                    <div className="add-course__action-icon">
